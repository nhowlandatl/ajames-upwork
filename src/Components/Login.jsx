...
// const federated = {
//   facebookAppId: "197530488546623", // app id goes here
//   oauthConfig: {
...
// **NOTE**
// Logging into facebook works and it receives token credentials, but it won't provide permissions to access/write to the Cognito user pool. It seems like you must use the hosted Cognito UI for Federated logins to read/write to the Cognito user pool (like changing name, email address, etc). This is a well documented issue with no AWS resolution. See https://github.com/aws-amplify/amplify-js/issues/399
