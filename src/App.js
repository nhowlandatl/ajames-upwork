          ...
          <Navbar collapseOnSelect bg="light" expand="md" className="mb-3">
            ...
            <Navbar.Collapse className="justify-content-end">
              <Nav>
                ...
                <Nav.Link href="https://ajamesamplifycaf4cbbd-caf4cbbd-dev.auth.us-east-1.amazoncognito.com/login?response_type=code&client_id=6ftnnbolk39qp9m24q1bo24724&redirect_uri=https://new-pool.dgcxtis8n2kl8.amplifyapp.com/">Signup or Login</Nav.Link>
                }
                {this.state.loggedIn === true &&
